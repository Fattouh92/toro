Toro::Application.routes.draw do
  ...
  match "/:date1/:date2/print_summary" => "summary#print_summary", :as => :summary_print
  ...
  post "/:check_id/combine" => "table#combine", :as => "combine_checks"
  post "/find_check" => "table#find_check", :as => "find_check"
